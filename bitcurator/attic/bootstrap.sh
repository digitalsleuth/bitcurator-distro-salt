...
#
# Build, upgrade, and configuration script to initialize salt install and execution
#
#
#===============================================================================
...
if [ $VER != "17.10" ] && [ $VER != "18.04" ]; then
    echo "MIDA is only usable on Ubuntu 17.10 and 18.04 at this time."
    exit 3
fi

if [ `whoami` != "root" ]; then
    echoerror "The MIDA bootstrap script must run as root."
    echoinfo "Preferred Usage: sudo bootstrap.sh -s -i -y"
    echo ""
    exit 3
fi
...
echoinfo "*********************************************************"
echoinfo "The MIDO bootstrap script will now configure your system."
echoinfo "*********************************************************"
echoinfo ""
